...
if (TYPO3_MODE === 'BE' && \R3H6\Error404page\Configuration\ExtensionConfiguration::get('doktypeError403page') && \R3H6\Error404page\Configuration\ExtensionConfiguration::get('feature403')) {
	\R3H6\Error404page\Utility\CustomPageUtility::addDoktype(
	    $_EXTKEY,
